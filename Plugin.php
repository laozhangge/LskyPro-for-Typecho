...
class LskyPro_Plugin implements Typecho_Plugin_Interface
{
     ...
     * 插件配置页面
     */
    public static function config(Typecho_Widget $form)
    {
     ...
     * 个人配置页面
     */
    public static function personalConfig(Typecho_Widget $form)
    {
        // 个人配置页面（暂不使用）
    }
    ...
    public static function render()
    {
        ...
        (function() {
            ...
            function showResult(url, name) {
                resultDiv.innerHTML = '<p><strong>URL:</strong></p>' +
                    '<input type="text" class="lskypro-result-input" value="' + url + '" onclick="this.select()" readonly>' +
                    '<p><strong>HTML:</strong></p>' +
                    '<input type="text" class="lskypro-result-input" value="<img src=\'' + url + '\' alt=\'' + name + '\' />" onclick="this.select()" readonly>' +
                    '<p><strong>Markdown:</strong></p>' +
                    '<input type="text" class="lskypro-result-input" value="![' + name + '](' + url + ')" onclick="this.select()" readonly>';
            }
            
            // 暴露给粘贴上传使用
            window.lskyproUploadFile = uploadFile;
        })();
        </script>
        <?php
    }
    ...
    private static function pluginUrl($path = '')
    {
        ...
        return $options->pluginUrl . '/LskyPro/' . $path;
    }
}
